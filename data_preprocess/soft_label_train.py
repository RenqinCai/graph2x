...
if __name__ == "__main__":
    ...
    dir_path = '../Dataset/ratebeer/{}'.format(args.dataset)
    ...
    sentence2id_filepath = '../Dataset/ratebeer/{}/train/sentence/sentence2id.json'.format(args.dataset)
    ...
    id2sentence_filepath = '../Dataset/ratebeer/{}/train/sentence/id2sentence.json'.format(args.dataset)
