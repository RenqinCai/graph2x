...
def main():
    ...
    if freeze_layers is not "":
        ...
        for layer_idx in layer_indexes:
            for name, param in list(model.distilbert.transformer.layer[layer_idx].named_parameters()):
                param.requires_grad = False 
                param_num = param.numel()
                total_freeze_param_num += param_num
    ...
    #             print(name, "\t", param_num)
        ...
        print("left parameters num for training", total_param_num-total_freeze_param_num)
