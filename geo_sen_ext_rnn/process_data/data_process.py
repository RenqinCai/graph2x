...
class DATA():
    ...
    def f_load_soft_ratebeer(self, args):
        ...
        train_data_obj = RATEBEER_TRAIN()
        vocab_obj = train_data_obj.load_raw_data(sent_content_file, sent_embed_file, feature_embed_file, useritem_candidate_soft_label_sen_file, user_feature_file, item_feature_file, sent_feature_file, graph_train_dir, True)
