...
class Vocab():
    ...
    def f_load_sent_content(self, sent_content_file):
        ...
        for sent_idx in range(sent_num):
            ...
            if sentid_i not in self.m_sent2sid:
                print("error missing sent id", sentid_i)
                continue
        ...
        print("load sent num", len(self.m_sid2swords)) 
...
class RATEBEER(Dataset):
    ...
    def load_train_data(self, useritem_candidate_label_sent_file, sent_feature_file, user_feature_file, item_feature_file, feature_embed_file, sent_embed_file, sent_content_file):
        ...
        vocab_obj.f_load_sent_content(sent_content_file)
